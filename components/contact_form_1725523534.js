<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Get Started on Your Coding Journey</h3>
        <p class="mt-3 text-black w-fit">Have questions or ready to begin? We're here to help!</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        ...
        <div>
          <label class="font-medium text-black">Programming Language of Interest</label>
        ...
        <div>
          <label class="font-medium text-black">Current Coding Experience Level</label>
          <textarea
            required
